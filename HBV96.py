...
def calibrate(flow, avg_prec, temp, et, p2, init_st=None, ll_temp=None, 
    ...
    # initial guess
    x_0 = [1.0, 2.0, 1.0, 0.3, 250.0, 1.0, 0.15, 0.4, 0.01, 0.0006, 0.5, 1.2, 0.1,
           0.8, 0.05, 0.125, 1.0, 1.0]
    ...
    x_b = zip(x_lb, x_ub)
#    x_0 = [np.random.uniform(x_lb[i], x_ub[i]) for i in xrange(len(x_ub))]
